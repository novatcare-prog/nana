...
final facilitySearchProvider = FutureProvider.family<List<Facility>, String>((ref, query) async {
  if (query.isEmpty) {
...
final facilitiesByCountyProvider = FutureProvider.family<List<Facility>, String>((ref, county) async {
  final repository = ref.watch(facilityRepositoryProvider);
